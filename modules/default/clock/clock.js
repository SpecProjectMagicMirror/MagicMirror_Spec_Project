        ...
        if (this.display)
            {
                ...
                if (this.config.displayType === "digital") {
                    ...
                    this.analogWrapper = document.createElement("div");
                    this.analogWrapper.id = "analog";
                    this.analogWrapper.style.cssFloat = "none";
                    this.analogWrapper.appendChild(clockCircle);
                    this.digitalWrapper = document.createElement("div");
                    this.digitalWrapper.id = "digital";
                    this.digitalWrapper.style.cssFloat = "none";
                    this.digitalWrapper.appendChild(dateWrapper);
                    this.digitalWrapper.appendChild(timeWrapper);

                    if (placement === "left" || placement === "right") {
                        this.digitalWrapper.style.display = "inline-block";
                        this.digitalWrapper.style.verticalAlign = "top";
                        this.analogWrapper.style.display = "inline-block";
                        if (placement === "left") {
                            this.analogWrapper.style.padding = "0 20px 0 0";
                            wrapper.appendChild(this.analogWrapper);
                            wrapper.appendChild(this.digitalWrapper);
                        } else {
                            this.analogWrapper.style.padding = "0 0 0 20px";
                            wrapper.appendChild(this.digitalWrapper);
                            wrapper.appendChild(this.analogWrapper);
                        }
                    } else {
                        this.digitalWrapper.style.textAlign = "center";
                        if (placement === "top") {
                            this.analogWrapper.style.padding = "0 0 20px 0";
                            wrapper.appendChild(this.analogWrapper);
                            wrapper.appendChild(this.digitalWrapper);
                        } else {
                            this.analogWrapper.style.padding = "20px 0 0 0";
                            wrapper.appendChild(this.digitalWrapper);
                            wrapper.appendChild(this.analogWrapper);
                        }
                    }
            ...
            {
                this.digitalWrapper.style = "visibility:hidden;";
                this.analogWrapper.style = "visibility:hidden;";
            }
