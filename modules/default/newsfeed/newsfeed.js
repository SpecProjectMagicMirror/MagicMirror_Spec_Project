...
Module.register("newsfeed",{
	...
	getDom: function() {
        ...
        if (this.display){
            ...
            if (this.newsItems.length > 0) 
                {
                    ...
                    {
                        this.sourceAndTimestamp = document.createElement("div");
                        this.sourceAndTimestamp.className = "light small dimmed";

                        if (this.config.showSourceTitle && this.newsItems[this.activeItem].sourceTitle !== "") 
                        {
                            this.sourceAndTimestamp.innerHTML = this.newsItems[this.activeItem].sourceTitle;
                        }
                        if (this.config.showSourceTitle && this.newsItems[this.activeItem].sourceTitle !== "" && this.config.showPublishDate) 
                        {
                            this.sourceAndTimestamp.innerHTML += ", ";
                        }
                        if (this.config.showPublishDate) 
                        {
                            this.sourceAndTimestamp.innerHTML += moment(new Date(this.newsItems[this.activeItem].pubdate)).fromNow();
                        }
                        if (this.config.showSourceTitle && this.newsItems[this.activeItem].sourceTitle !== "" || this.config.showPublishDate) 
                        {
                            this.sourceAndTimestamp.innerHTML += ":";
                        ...
                        wrapper.appendChild(this.sourceAndTimestamp);
                    }
                    ...
                    this.newstitle = document.createElement("div");
                    this.newstitle.className = "bright medium light";
                    this.newstitle.innerHTML = this.newsItems[this.activeItem].title;
                    wrapper.appendChild(this.newstitle);

                    if (this.config.showDescription) {
                        this.description = document.createElement("div");
                        this.description.className = "small light";
                        this.description.innerHTML = this.newsItems[this.activeItem].description;
            ...
            this.newstitle.style = "visibility:hidden;";
            //this.description.style = "visibility:hidden;";
            this.sourceAndTimestamp = "visibility:hidden;";
        }
